...
export const MOCK_WORK_ORDERS: WorkOrder[] = [
  {
    ...
    evidenceMinMet: true,
    stateEnteredAt: '2025-01-08T11:45:00Z',
    laborHours: 4.5,
    partsCost: 187000,
    totalCost: 187000,
    partsUsed: [
  ...
  },
  {
    ...
    evidenceMinMet: true,
    stateEnteredAt: '2025-01-07T18:30:00Z',
    laborHours: 3.5,
    partsCost: 45000,
    totalCost: 45000,
    partsUsed: [
  ...
  },
  {
    ...
    evidenceMinMet: true,
    stateEnteredAt: '2024-12-28T16:30:00Z',
    laborHours: 4.5,
    partsCost: 320000,
    totalCost: 320000,
    partsUsed: [
  ...
  // New open work orders
  {
    ...
    dueBy: new Date(Date.now() + 5 * 60 * 60 * 1000).toISOString(),
  ...
  },
  {
    ...
    dueBy: new Date(Date.now() + 18 * 60 * 60 * 1000).toISOString(),
  ...
  },
  {
    ...
    dueBy: new Date(Date.now() + 36 * 60 * 60 * 1000).toISOString(),
    attachments: [],
    photos: [],
    notes: [],
    evidenceMinMet: false,
  ...
  },
  {
    ...
    dueBy: new Date(Date.now() + 30 * 60 * 60 * 1000).toISOString(),
    attachments: [],
    photos: [],
    notes: [],
    evidenceMinMet: false,
