...
export const MOCK_WORK_ORDERS: WorkOrder[] = [
  ...
  {
    id: 'WO-2025-00146',
    equipmentId: 'EQ-AC-005',
    equipmentName: 'Air Conditioning Unit AC-LOS-22',
    site: 'LOS',
    area: 'Terminal Building',
    type: 'corrective',
    priority: 'high',
    title: 'AC unit not cooling - compressor failure suspected',
    description: 'Air conditioning unit in departure lounge not providing adequate cooling. Temperature exceeding 32°C.',
    requester: 'Terminal Manager',
    ...
    stateEnteredAt: '2025-01-10T09:00:00Z',
    safetyTags: ['Refrigerant Handling', 'LOTO Required'],
  },
  {
    id: 'WO-2025-00147',
    equipmentId: 'EQ-TUG-008',
    equipmentName: 'Pushback Tug TUG-LOS-117',
    site: 'LOS',
    area: 'Ramp Operations',
    type: 'corrective',
    priority: 'critical',
    title: 'Tug engine overheating - coolant leak',
    description: 'Engine temperature warning light on. Visible coolant leak from radiator hose.',
    requester: 'Ramp Supervisor',
    requesterId: 'user-003',
    assignedBy: 'Engr. Adewale Okonkwo',
    assignees: ['Tech. Chidi Okafor'],
    status: 'assigned',
    reportedAt: '2025-01-10T10:15:00Z',
    attachments: [],
    photos: [],
    notes: [],
    evidenceMinMet: false,
    stateEnteredAt: '2025-01-10T10:30:00Z',
    safetyTags: ['Hot Engine', 'Coolant Handling'],
  },
  {
    id: 'WO-2025-00143',
